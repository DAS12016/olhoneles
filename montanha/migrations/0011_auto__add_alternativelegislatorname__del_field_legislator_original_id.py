...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(
            u'montanha_legislator_alternative_names')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(
                verbose_name='ID', primary_key=True, auto_created=True)),
            ('legislator', models.ForeignKey(
                orm[u'montanha.legislator'], null=False)),
            ('alternativelegislatorname', models.ForeignKey(
                orm[u'montanha.alternativelegislatorname'], null=False))
        ))
        db.create_unique(m2m_table_name, [
            'legislator_id', 'alternativelegislatorname_id'])

    def backwards(self, orm):
        # Deleting model 'AlternativeLegislatorName'
        db.delete_table(u'montanha_alternativelegislatorname')

        # User chose to not deal with backwards NULL issues
        # for 'Legislator.original_id'
        raise RuntimeError("Cannot reverse this migration. 'Legislator.original_id' and its values cannot be restored.")

        # The following code is provided here to aid
        # in writing a correct migration
        # Adding field 'Legislator.original_id'
    ...
    models = {
        ...
        u'montanha.legislator': {
            ...
            'alternative_names': (
                'django.db.models.fields.related.ManyToManyField', [], {
                    'to': u"orm['montanha.AlternativeLegislatorName']",
                    'symmetrical': 'False'}),
        ...
        u'montanha.perlegislator': {
            ...
            'legislator': ('django.db.models.fields.related.ForeignKey', [], {
                'to': u"orm['montanha.Legislator']"}),
            'legislature': ('django.db.models.fields.related.ForeignKey', [], {
                'to': u"orm['montanha.Legislature']", 'null': 'True',
                'blank': 'True'})
        },
