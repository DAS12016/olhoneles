...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'montanha_pernaturebyyear', 'expensed', self.gf(
            'django.db.models.fields.DecimalField')
            (max_digits=20, decimal_places=2))

        # Changing field 'PerNature.expensed'
        db.alter_column(u'montanha_pernature', 'expensed', self.gf(
            'django.db.models.fields.DecimalField')
            (max_digits=20, decimal_places=2))

        # Changing field 'PerLegislator.expensed'
        db.alter_column(u'montanha_perlegislator', 'expensed', self.gf(
            'django.db.models.fields.DecimalField')
            (max_digits=20, decimal_places=2))

        # Changing field 'PerNatureByMonth.expensed'
        db.alter_column(u'montanha_pernaturebymonth', 'expensed', self.gf(
            'django.db.models.fields.DecimalField')
            (max_digits=20, decimal_places=2))

        # Changing field 'BiggestSupplierForYear.expensed'
        db.alter_column(u'montanha_biggestsupplierforyear', 'expensed',
