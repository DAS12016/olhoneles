...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'montanha_politicalparty', 'siglum', self.gf(
            'django.db.models.fields.CharField')(unique=True, max_length=15))

    def backwards(self, orm):

        # Changing field 'PoliticalParty.siglum'
        db.alter_column(u'montanha_politicalparty', 'siglum', self.gf(
            'django.db.models.fields.CharField')(max_length=10, unique=True))
