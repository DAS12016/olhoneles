...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'montanha_legislator', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')
                (max_length=2048)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')
                (max_length=100, null=True, blank=True)),
        ))
        ...
        db.create_table(u'montanha_mandate', (
            ...
            ('legislator', self.gf(
                'django.db.models.fields.related.ForeignKey')
                (to=orm['montanha.Legislator'])),
            ('legislature', self.gf(
                'django.db.models.fields.related.ForeignKey')
                (to=orm['montanha.Legislature'])),
            ('date_start', self.gf('django.db.models.fields.DateField')()),
            ('date_end', self.gf('django.db.models.fields.DateField')
                (null=True, blank=True)),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')
                (to=orm['montanha.PoliticalParty'], null=True, blank=True)),
        ))
        ...
        db.create_table(u'montanha_expensenature', (
            (u'id', self.gf('django.db.models.fields.AutoField')
                (primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.CharField')
        ...
        db.create_table(u'montanha_expense', (
            ...
            ('number', self.gf('django.db.models.fields.CharField')
                (max_length=512)),
            ('nature', self.gf('django.db.models.fields.related.ForeignKey')
                (to=orm['montanha.ExpenseNature'])),
            ...
            ('mandate', self.gf('django.db.models.fields.related.ForeignKey')
                (to=orm['montanha.Mandate'])),
        ...
        db.create_table(u'montanha_supplier', (
            (u'id', self.gf('django.db.models.fields.AutoField')
                (primary_key=True)),
            ('identifier', self.gf('django.db.models.fields.CharField')
                (max_length=256)),
            ('name', self.gf('django.db.models.fields.CharField')
                (max_length=200)),
        ))
    ...
    models = {
        u'montanha.expense': {
            ...
            'value': ('django.db.models.fields.DecimalField', [], {
                'null': 'True', 'max_digits': '10', 'decimal_places':
                '2', 'blank': 'True'})
        },
        ...
        u'montanha.legislature': {
            ...
            'date_end': ('django.db.models.fields.DateField', [], {
                'null': 'True', 'blank': 'True'}),
            'date_start': ('django.db.models.fields.DateField', [], {}), u'id':
        ...
        u'montanha.mandate': {
            ...
            'party':
                ('django.db.models.fields.related.ForeignKey', [], {
                    'to': u"orm['montanha.PoliticalParty']", 'null':
                    'True', 'blank': 'True'})
        },
